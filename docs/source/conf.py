...
project = u'SpacePY-X'
copyright = u'2019, Andrew Shapton'
author = u'Andrew Shapton'
...
htmlhelp_basename = 'SpacePY-Xdoc'
...
latex_documents = [
    (master_doc, 'SpacePY-X.tex', u'SpacePY-X Documentation',
     u'Andrew Shapton', 'manual'),
]
